...
const strings = {
  no: {
    ...
    'scan.uncertainBody': 'Resultatet har ikke høy treffsikkerhet fordi bildet er uklart.',
  ...
  sv: {
    ...
    'scan.uncertainBody': 'Resultatet har inte hög träffsäkerhet eftersom bilden är oklar.',
  ...
  da: {
    ...
    'scan.uncertainResult': 'Usikkert resultat',
    'scan.uncertainBody': 'Resultatet har ikke høj træfsikkerhed, fordi billedet er uklart.',
